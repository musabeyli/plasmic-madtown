          ...
          <div className={classNames(projectcss.all, sty.freeBox__mDtZy)}>
            ...
            >
              ...
              <div className={classNames(projectcss.all, sty.column__ulj3T)}>
                ...
                <form onSubmit={() => router.push("/product")} method="POST">
                  <div
                  ...
                  >
                    ...
                    <VStack marginBottom={"20px"}>
                      ...
                      <Text
                        ...
                        fontWeight="bold"
                      >
                        {"43.69 with Paypal valid thru 08/22."}
                      </Text>
                      <PayPalButtons
                        ...
                        onApprove={(data, actions) => {
                          return actions.order.capture().then((details) => {
                            ...
                            alert(
                              `Thank you for your purchase ${name}. We will be sending out confirmation email shortly. Go Badgers! :)`
                            );
                          });
                        }}
                      /> */}
