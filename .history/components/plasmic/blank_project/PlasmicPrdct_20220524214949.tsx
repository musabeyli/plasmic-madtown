...
function PlasmicPrdct__RenderFunc(props: {
  ...
  const handleSubmit: React.FormEventHandler<HTMLFormElement> = async (e) => {
    ...
    const rawResponse = await fetch("/api/checkout_sessions", {
      ...
      console.log("thats a res ", response);
    });
    ...
    // await fetch(
    //   "https://checkout.stripe.com/pay/cs_live_a1gaq1KzqrSbJDIKca8gaIGjScRNBkCYfmql55L4BY9zGl8EMrEnN3bOjQ#fidkdWxOYHwnPyd1blppbHNgWjA0STVydExJXz1RSHdscGloSXRuZE93bm9Ga2dKfzVkaGA1X3xIYnZkSWB%2FcGNKNnMwQ09ibGB3NU99QjFMMm1USDFqSXQyTDM9R04yXzZkVDNdMUh3a0hGNTU1NE1rN2xcSycpJ2N3amhWYHdzYHcnP3F3cGApJ2lkfGpwcVF8dWAnPyd2bGtiaWBabHFgaCcpJ2BrZGdpYFVpZGZgbWppYWB3dic%2FcXdwYHgl",
    //   {
    //     credentials: "omit",
    //     headers: {
    //       "User-Agent":
