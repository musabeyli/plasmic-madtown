...
function PlasmicPrdct__RenderFunc(props: {
  ...
  const items = [
    ...
    },
    {
      ...
      thumbnail: "https://p16-sign.tiktokcdn-us.com/obj/tos-useast5-p-0068-tx/c2779fb4c6744d41952f1f20f2b6a31e_1658439569?x-expires=1658865600&x-signature=AVeGynYBSPhl%2FQusc6sZ%2FHntTSs%3D&s=AWEME_DETAIL&se=false&sh=&sc=dynamic_cover&l=20220726140005B4A485FA63801E13E00B"
      altTitle: "item #1",
    },
    {
              ...
              <div className={classNames(projectcss.all, sty.column__ulj3T)}>
                ...
                <Carousel>
                  {items.map((item) => (
                    ...
                    //   as="img"
                    //   controls
                    //   src="/plasmic/blank_project/images/website_images/gamebox_back_cover.JPG"
                    //   poster="https://peach.blender.org/wp-content/uploads/title_anouncement.jpg?x11217"
                    //   alt="Big Buck Bunny"
                    //   objectFit="contain"
                    //   sx={{
