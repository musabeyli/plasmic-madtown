...
function PlasmicPrdct__RenderFunc(props: {
        ...
        {state.showVideo[item.embedUrl] ? (
          <div className="video-wrapper">
            <a
              ...
              onClick={_toggleShowVideo.bind(item.embedUrl)}
            ></a>
            <iframe
              width="560"
              height="315"
          ...
          <a onClick={_toggleShowVideo.bind(item.embedUrl)}>
  ...
  function _toggleShowVideo(url) {
    ...
    if (state.showVideo[url]) {
      if (state.showPlayButton) {
        state.showGalleryPlayButton = false;
        // setState({ showGalleryPlayButton: false });
      }

      if (state.showFullscreenButton) {
        state.showGalleryFullscreenButton = false;
        setState({ showGalleryFullscreenButton: false });
      }
    }
  }
