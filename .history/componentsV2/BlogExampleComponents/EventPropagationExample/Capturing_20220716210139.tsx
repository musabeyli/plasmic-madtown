    ...
    >
      ...
      >
        ...
        <Box
          ...
          borderRadius="10px"
          boxShadow={
            propagateLevel.includes(2) ? "0px 0px 50px green" : "initial"
          }
        >
          ...
          <Box
            ...
            borderRadius="10px"
            boxShadow={
              propagateLevel.includes(3) ? "0px 0px 50px red" : "initial"
            }
          ></Box>
        </Box>
      </Box>
