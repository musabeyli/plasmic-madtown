...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: Tdl-6_vz1DB/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: eL6LYOdI6RC/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__lLaA)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__y2Bre)}
              />
            </React.Fragment>
          ),
          value: args.children
